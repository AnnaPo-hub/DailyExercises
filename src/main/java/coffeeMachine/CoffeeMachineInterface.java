...
public class CoffeeMachineInterface {
    ...
    public static void sellCoffee(String coffeeSelected, CoffeeMachineData coffeeMachineData) {
        ...
        if (ingredientIfAbsent.equals("enough")) {
            ...
            switch (coffeeSelected) {
                ...
                case "back":
                    break;
                default:
                    System.out.println("Wrong option, pls check");
            }
        } else {
    ...
    public static CoffeeAssortment transformNumberToCoffeeType(String coffeeSelected) {
        switch (coffeeSelected) {
            case "1":
